...
PROMPTS: Dict[str, str] = {
    "Narrative": (
        ...
        "Follow-up:\n\n"
        "**Guidelines:**\n"
        "- **HPI**: Extract from patient's statements - include age/gender if mentioned, chief complaint, symptom timeline (onset, duration), character of symptoms, associated symptoms, what makes better/worse, relevant history. **Use a professional narrative paragraph format.**\n"
        ...
        "- **Assessment**: List working diagnoses with supporting evidence from the transcript. For example: '1. Crohn's Disease, moderate activity - supported by fecal calprotectin of 650'.\n"
        ...
        "- Extract findings **strictly** from the provided transcript.\n"
        "- **CRITICAL:** Do NOT fabricate or infer any information. If a detail (like medication dose, duration, or specific symptom) is not explicitly spoken in the transcript, you MUST write 'Not documented'.\n"
    ...
    "SOAP": (
        ...
        "- **CRITICAL:** Do NOT hallucinate. If a specific measurement, dosage, or symptom is not present in the audio, state 'Not documented'.\n\n"
        "**Transcript:**\n"
        "{transcript}\n\n"
        "**Your SOAP note:**"
    ),
