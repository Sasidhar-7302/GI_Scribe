...
class StorageManager:
    ...
    def persist(
        ...
        try:
            ...
            import logging
            logger = logging.getLogger("medrec.storage")
            logger.error(f"Failed to persist session to {session_dir}: {e}")
            raise RuntimeError(f"Storage Error: Could not save session data. {e}")
